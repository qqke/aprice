...
async function main() {
  ...
  try {
    ...
    assert.equal(mobileMenuDisplay, 'none', 'mobile subpages should hide the top menu toggle');
    assert.equal(await page.locator('#mobile-nav').isHidden(), true, 'mobile subpages should keep the top nav hidden');
